...
public class Jinzhizh extends Fragment implements OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      /*  t1.setAnimation(animation1);
       ...
       // Animation  animation1 = new TranslateAnimation(-30, 0, 0 , 0);    //RotateAnimation  ?????????ฃ?????งน??  
       // animation1.setDuration(800); 
     //   Animation  animation2 = new TranslateAnimation(30, 0, 0 , 0);    //RotateAnimation  ?????????ฃ?????งน??  
      //  animation2.setDuration(800);
        Animation animation = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????งน??
        animation.setDuration(800);
       // animation.setStartOffset(500);
        Animation animation2 = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????งน??
        animation2.setDuration(800);
        animation2.setStartOffset(100);
        Animation animation3 = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????งน??
        animation3.setDuration(800);
        animation3.setStartOffset(300);
        Animation animation4 = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????งน??
        animation4.setDuration(800);
