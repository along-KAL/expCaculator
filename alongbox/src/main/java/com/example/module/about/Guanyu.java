...
public class Guanyu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* Animation animation = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????完??
        animation.setDuration(800);
        animation.setStartOffset(200);
        Animation animation2 = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????完??
        animation2.setDuration(800);
        animation2.setStartOffset(300);
        Animation animation3 = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????完??
        animation3.setDuration(800);
        animation3.setStartOffset(400);
        Animation animation4 = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????完??
        animation4.setDuration(800);
        animation4.setStartOffset(500);
        Animation animation5 = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????完??
        animation5.setDuration(800);
        animation5.setStartOffset(600);
        Animation animation6 = new AlphaAnimation(0.0F,1.0f);   //AlphaAnimation ???????????????完??
