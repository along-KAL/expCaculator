...
public class WheelView extends View {
	...
	// Listeners
	private List<com.example.module.timer.selecttimee.OnWheelChangedListener> changingListeners = new LinkedList<com.example.module.timer.selecttimee.OnWheelChangedListener>();
	private List<com.example.module.timer.selecttimee.OnWheelScrollListener> scrollingListeners = new LinkedList<OnWheelScrollListener>();
