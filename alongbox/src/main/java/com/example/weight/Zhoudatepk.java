...
view = inflater.inflate(R.layout.zhoudatepk, null);
textview=(TextView)view.findViewById(R.id.date_picker_ok);


dt = (LinearLayout)view.findViewById(R.id.zhoudatepk);
//监听屏幕动静
bmp1 = bmp;
...
mDatePicker = (DatePicker) view.findViewById(R.id.ZHOUdatePicker);
...
private void setButton() {
	...
	mDatePicker.getDayOfMonth(),"y",bmp);
	}
	dismiss();
	}
	});
