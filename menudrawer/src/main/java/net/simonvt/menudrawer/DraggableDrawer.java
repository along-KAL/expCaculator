...
public abstract class DraggableDrawer extends MenuDrawer {
    ...
    public void setOnMenuCloseListener(OnMenuCloseListner onMenuCloseListener){
        this.mOnMenuCloseListener = onMenuCloseListener;
    }
    private OnMenuCloseListner mOnMenuCloseListener;
    public interface OnMenuCloseListner{
        void onClose();
    }
    ...
    private void postAnimationInvalidate() {
        ...
        if(mOnMenuCloseListener!=null){
            mOnMenuCloseListener.onClose();
        }
        mOnMenuCloseListener = null;
        completeAnimation();
    }
